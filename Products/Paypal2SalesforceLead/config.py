# location of Paypal IPN verification service
PAYPAL_VERIFIER = 'https://www.paypal.com/cgi-bin/webscr'
PAYPAL_VERIFIER_SANDBOX = 'https://www.sandbox.paypal.com/cgi-bin/webscr'
